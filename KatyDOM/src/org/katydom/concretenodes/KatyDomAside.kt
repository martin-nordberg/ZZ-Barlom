 ...
 */
internal class KatyDomAside : KatyDomHtmlElement {

    /**
     * Constructs a new aside element with minimal attributes.
     */
    constructor(
        selector: String?,
        key: String?,
    ...
    /**
     * Constructs a new aside element with global elements beyond id and class.
     */
    constructor(
        selector: String?,
        key: String?,
