...
//    val headVertexType: IVertexType
    ...
    /** Links to the sub types of this edge type. */
    val subTypeDirectedEdgeTypeInheritances: List<DirectedEdgeTypeInheritance>
        get() = _subTypeDirectedEdgeTypeInheritances.sortedBy { i -> i.subType.path }
    ...
    val superTypeDirectedTypeInheritances: List<DirectedEdgeTypeInheritance>
        get() = _superTypeDirectedEdgeTypeInheritances.sortedBy { i -> i.superType.path }
...
//    val transitiveSubTypes: List<DirectedEdgeType>
